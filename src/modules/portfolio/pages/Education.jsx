        ...
        >
          ...
          <Container fluid style={{ textAlign: 'center' }}>
            <Row style={{ display: 'inline-flex' }}>
              <EducationCard
                // image={UMassLogo}
                fallback_image="/img/umass-logo.jpg"
                ...
                details={
                  <>
                    • Major: Computer Science & Engineering (Development &
                    Analysis)
                    <br />
                    • Major Subject, Data Structure & Algoriths, Big Data
              ...
              <EducationCard
                // image={DPSRKPLogo}
                fallback_image="/img/dpsrkp-logo.jpg"
                ...
                details={
                  <>
                    • Major subject- Chemistry, Mathematics, Physics, Hindi,
                    English
                    <br />
                    • Optianal Subject- Computer Science
                    <br />• Cleared NDA Examination.
                  </>
                }
              />
              <EducationCard
                ...
                details={
                  <>
                    • Major Science - Physical science, Life science,
                    Mathematics
                    <br />

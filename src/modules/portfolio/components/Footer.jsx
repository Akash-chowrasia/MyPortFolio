    ...
    return (
      ...
      >
        <Nav className="mx-auto">
          ...
          {/* HackerRank */}
          <Nav.Link
            href="https://www.hackerrank.com/chowrasia_akash1"
            target="_blank"
          >
          ...
          {/* Leetcode */}
          <Nav.Link
            href="https://leetcode.com/Akash_Chowrasia/"
            target="_blank"
          >
          ...
          {/* GeeksforGeeks */}
          <Nav.Link
            href="https://auth.geeksforgeeks.org/user/akash_chowrasia/profile"
            target="_blank"
          >
            {smallViewArray[5]}
          </Nav.Link>
          {/* Keggle */}
          <Nav.Link
            href="https://www.kaggle.com/akashchowasia08"
            target="_blank"
          >
          ...
          {/* facebook */}
          <Nav.Link
            href="https://www.facebook.com/akash.chowrasia.908/"
            target="_blank"
          >
          ...
          {/* Instagram */}
          <Nav.Link
            href="https://www.instagram.com/akash_chowrasia/"
            target="_blank"
          >
